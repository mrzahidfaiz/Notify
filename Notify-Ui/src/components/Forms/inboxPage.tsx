    ...
    return (
            <main>
                ...
                <div className="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3 mb-5">
                    ...
                    {/*  */}
                    <button
                        className="flex items-center justify-center px-4 py-2 text-sm font-medium text-black rounded-lg bg-meta-5 hover:bg-primary-800 focus:ring-4 focus:ring-body dark:bg-body dark:hover:bg-boxdark-2 dark:text-white focus:outline-none dark:focus:ring-white"
                    >
                        <svg
                            className="h-3.5 w-3.5 mr-2"
                            fill="currentColor"
                ...
                <div className="relative bg-white shadow-sm mb-4 dark:bg-graydark sm:rounded-lg">
                    ...
                    <div className="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                        ...
                        <div className="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                            <button
                                className="flex items-center justify-center px-4 py-2 text-sm font-medium text-black rounded-lg bg-meta-1 hover:bg-primary-800 focus:ring-4 focus:ring-body dark:bg-body dark:hover:bg-boxdark-2 dark:text-white focus:outline-none dark:focus:ring-white"
                            >
                                <svg
                                    className="h-3.5 w-3.5 mr-2"
                                    fill="currentColor"
                ...
                <div className="w-full overflow-hidden rounded-lg shadow-xs">
                    <div className="w-full overflow-x-auto">
                        <table className="w-full whitespace-no-wrap">
                            <thead>
                                <tr className="text-sm font-semibold tracking-wide text-left text-graydark uppercase border-b dark:border-graydark bg-slate-200 dark:text-gray-400 dark:bg-boxdark">
